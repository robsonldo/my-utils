package br.com.robsonldo.library.view.watcher;
...
public class MaskMoney implements TextWatcher {
    ...
    public BigDecimal unmask() {
        String value = editTextWeakReference.get().getText().toString();
        return parseToBigDecimal(value, locale);
    }

    public static String mask(Double value, Locale locale) {
    ...
    private BigDecimal parseToBigDecimal(String value, Locale locale) {
        ...
        if(cleanString.equals("")) return null;
